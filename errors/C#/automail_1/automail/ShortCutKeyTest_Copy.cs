...
namespace automail
{
    internal class ShortCutKeyTest_Copy
    {
        ...
        public ShortCutKeyTest_Copy()
        {
            ...
            /*IntPtr ptrNotepad = FindWindow("Notepad", "test - 记事本");
            IntPtr ptrChildAfter = new IntPtr();
            IntPtr ptrEdit = FindWindowEx(ptrNotepad, ptrChildAfter, "Edit", null);*/
          
            /*PostMessage(ptrEdit, 256, Keys.Control, 1);
            PostMessage(ptrEdit, 256, Keys.Shift, 1);
            PostMessage(ptrEdit, 256, Keys.S, 1);*/
           /* PostMessage(ptrEdit, 256, Keys.ControlKey, 1);
            PostMessage(ptrEdit, 256, Keys.ShiftKey, 1);
            PostMessage(ptrEdit, 256, Keys.S, 1);*/
